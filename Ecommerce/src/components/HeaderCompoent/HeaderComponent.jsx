...
import image from '../../assets/images/logoheadergoc-removebg-preview (1).png'
import imagee from '../../assets/images/logoheader.png'
  ...
  return (
    <div style={{  heiht: '100%', width: '100%', display: 'flex',background: '#9255FD', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
        <WrapperTextHeader onClick={() => navigate('/')} src={image} style={{width: '100%', height: '100px', objectFit: 'cover'}}/>
        </Col>
        <WrapperTextHeader onClick={() => navigate('/')} src={imagee} style={{width: '100%', height: '105px', objectFit: 'cover'}}/>
        {!isHiddenSearch && (
          <Col span={10}>
            <ButttonInputSearch
              size="large"
